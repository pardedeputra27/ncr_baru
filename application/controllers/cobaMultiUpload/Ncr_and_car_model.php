...
class Ncr_and_car_model extends CI_Model
{
    ...
    public function tambahDataNcr()
    {
        $data = [
            ...
            'nco_date'          => $this->input->post('nco_date', true),
            ...
            'ncr_rec_date'      => $this->input->post('ncr_rec_date', true),
            ...
            'ver_date'          => $this->input->post('ver_date', true),
            'status_ncr'        => FALSE
    ...
    public function tambahDataCar()
    {
        $data = [
            ...
            'date_car'          => $this->input->post('date_car', true),
    ...
    public function dateUpdateStatusNcr ($id){
        $data = [
            'id_ncr'            => $id,
        ...
        $this->db->insert('data_updated_status_ncr',$data);
    }
